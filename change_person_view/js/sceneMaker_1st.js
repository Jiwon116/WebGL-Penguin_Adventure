...
/*       camera.position.x += 0.05;
      camera.position.y = cameraCenter.y + penguinVec.y;
      camera.position.z = cameraCenter.z + penguinVec.z; */
  }
  if (moveRight) {
  ...
  // 펭귄의 벡터 값을 카메라에 옮겨야하는데에ㅔㅇ
  // 왜 안돼?

/*   camera.position.x = cameraCenter.x + penguinVec.x;
  camera.position.y = cameraCenter.y + penguinVec.y;
  camera.position.z = cameraCenter.z + penguinVec.z; */
}
